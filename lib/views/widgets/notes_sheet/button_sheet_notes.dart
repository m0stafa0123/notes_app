...
import 'package:flutter_application_1/views/widgets/notes_sheet/form_button_sheet.dart';
      ...
      child: BlocConsumer<AddNoteCubit, AddNoteState>(
        ...
        builder: (context, state) {
          return AbsorbPointer(
            absorbing: state is AddNotelaoding ? true : false,
            child: Padding(
              ...
              child: const SingleChildScrollView(child: FormButtonSheet()),
            ),
          );
        },
      ),
